...
class SpamGuard():
    def __init__(self):
        self.blocking = False
        self.restricted = ['jsdf','dmitri', 'aguest']
        self.blocklist = ['Trivia', 'Internets','Icara','Tokino', 'Quotes', 'Onee-chan']
        self.readlog_time = 0
        self.commandlist = '$money $time $settimezone $anime $blackjack $loan $pay $debt $log $help .trivia .strivia .quote !snowball !ne~ !love !seen .cc !hangman !5050 .rank .t !rr !pull !roulette s/ !tell $tell'.split()
